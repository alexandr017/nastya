        ...
        <div class="card-body">
            <form method="post" action="/admin-panel/attractions/edit/{{$id}}">
                ...
                <div class="form-group">
                    <label for="category_id" class="col-form-label"><i>*</i> Категория</label>
                ...
                <div class="form-group">
                    <label for="alias" class="col-form-label"><i>*</i> URL-альяс (/attractions/{alias})</label>
                ...
                <div class="form-group">
                    <label for="distance_from_center" class="col-form-label"><i>*</i> Расстояние от цента (в км)</label>
                    <input id="distance_from_center" name="distance_from_center" type="number" min="0" max="350" step="0.1" class="form-control" required value="{{$attraction->distance_from_center}}">
                </div>

                <div class="form-group">
                    <label for="is_free_entry" class="col-form-label"><i>*</i> Бесплатный вход</label>
                ...
                <div class="form-group">
                    <label for="is_availability_of_excursions" class="col-form-label"><i>*</i> Наличие экскурсии</label>
